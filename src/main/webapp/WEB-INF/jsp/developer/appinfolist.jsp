		...
		<div class="x_panel">
			...
			<div class="x_content">
				<form method="post" action="dev/flatform/app/list">
					<input type="hidden" id="pageIndexId" name="pageIndex" value="1" />
			    <ul>
					<li>
						<div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12">软件名称</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input id="softwareName" name="querySoftwareName" type="text" class="form-control col-md-7 col-xs-12" value="${querySoftwareName }">
							</div>
						</div>
					</li>
					...
					<li><button id="selectBtn" type="submit" class="btn btn-primary"> 查 &nbsp;&nbsp;&nbsp;&nbsp;询 </button></li>
				</ul>
			</form>
		</div>
	</div>
	...
	<div class="x_panel">
		<div class="x_content">
			...
			<div id="datatable-responsive_wrapper"
				...
				<div class="row">
					<div class="col-sm-12">
					<a href="dev/flatform/app/appinfoadd" class="btn btn-success btn-sm">新增APP基础信息</a>
...
<script src="statics/localjs/appinfolist.js" type="text/javascript" charset="UTF-8"></script>
